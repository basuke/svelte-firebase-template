...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 8, 4, 145);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file$1, 9, 17, 185);
    			add_location(p, file$1, 9, 4, 172);
    			attr_dev(main, "class", "svelte-u9qvfs");
    			add_location(main, file$1, 7, 0, 134);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ WelcomeFirebase: Firebase_welcome, name, app });
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { name: 0, app: 1 });
