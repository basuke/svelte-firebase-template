...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	function uploadform_selected_binding(value) {
    		/*uploadform_selected_binding*/ ctx[3].call(null, value);
    	}
    	...
    	let if_block = /*file*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file_1, 11, 4, 222);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file_1, 12, 17, 262);
    			add_location(p, file_1, 12, 4, 249);
    			attr_dev(main, "class", "svelte-u9qvfs");
    			add_location(main, file_1, 10, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [name, file, app, uploadform_selected_binding];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { name: 0, app: 2 });
